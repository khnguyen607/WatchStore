                            ...
                            '<fieldset class="">' +
                                ...
                                '<div class="select-colors-theme colors-theme-primary mb-10">' +
                                    ...
                                    '<div class="more-select">' +
                                        '<img src="assets/images/bg-menu/more.png" alt="">' +
                                    '</div>' +
                                '</div>' +
                            '</fieldset>' +
                            '<fieldset class="">' +
                            ...
                            '<fieldset class="">' +
                                ...
                                '<div class="select-colors-theme image-menu-background mb-10">' +
                                    '<div class="item image img-1">' +
                                        '<img src="assets/images/bg-menu/img-1.png" alt="">' +
                                    '</div>' +
                                    '<div class="item image img-2">' +
                                        '<img src="assets/images/bg-menu/img-2.png" alt="">' +
                                    '</div>' +
                                    '<div class="item image img-3">' +
                                        '<img src="assets/images/bg-menu/img-3.png" alt="">' +
                                    '</div>' +
                                    '<div class="item image img-4">' +
                                        '<img src="assets/images/bg-menu/img-4.png" alt="">' +
                                    '</div>' +
                                    '<div class="item image img-5">' +
                                        '<img src="assets/images/bg-menu/img-5.png" alt="">' +
                                    '</div>' +
                                '</div>' +
                            '</fieldset>' +
                            '<div class="tf-button cursor-pointer w-full button-clear-select">Clear all</div>' +
